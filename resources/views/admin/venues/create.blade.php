...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('Product') }}
    </div>
    ...
    <div class="card-body">
        <form action="{{ route("admin.venues.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('location_id') ? 'has-error' : '' }}">
                <label for="location">{{ trans('Brands') }}*</label>
            ...
            <div class="form-group {{ $errors->has('event_types') ? 'has-error' : '' }}">
                <label for="event_types">{{ trans('Categories') }}
            ...
            <div class="form-group {{ $errors->has('price_per_hour') ? 'has-error' : '' }}">
                <label for="price_per_hour">{{ trans('Price') }}</label>
